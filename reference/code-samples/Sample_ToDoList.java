...
public class Sample_ToDoList {
    ...
    public static void main(String[] args) {
        Sample_ToDoList todoList = new Sample_ToDoList();
        // インスタンス化することで Sample_ToDoListクラスのメソッドを使用することができる
        ...
        while (true) { // trueを引数に与えると無限ループになります
            ...
            switch (choice) {
                case 1:
                    ...
                    // Sample_ToDoListクラスのaddItemメソッドを実施します
                ...
                case 3:
                    ...
                    // Sample_ToDoListクラスのdisplayItemsメソッドを実行します
